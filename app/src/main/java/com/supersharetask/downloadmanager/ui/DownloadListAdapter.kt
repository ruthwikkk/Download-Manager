...
import com.supersharetask.downloadmanager.utils.getDownloadProgress

class DownloadListAdapter(
    private val onPauseResumeClick: (DownloadItem) -> Unit,
    private val onCancelDownloadClick: (DownloadItem) -> Unit
) : ListAdapter<DownloadItem, DownloadListAdapter.DownloadItemViewHolder>(DownloadItemComparator) {
